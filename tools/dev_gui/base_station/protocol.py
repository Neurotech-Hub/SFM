...
# Friendly one-line purpose text for COMMAND log rows. Shared by manual
# command dispatch (app.py) and experiment-issued commands (gui_controller.py)
# so both surfaces render identically under the log's COMMAND filter.
CAN_CMD_PURPOSE = {
